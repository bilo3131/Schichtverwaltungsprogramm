...
SECRET_KEY = 'django-insecure-_-=t%@mu)c+v=22y-i@l8xgott^5g168#t4785ubexpg=qvtkr'
...
# CORS Settings (für Frontend-Entwicklung)
...
# Media Files (für Upload von Dokumenten)
MEDIA_URL = '/media/'
